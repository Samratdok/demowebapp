...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h1 class="text-center">My job is done with jenkins again</h1>
      <h2 class="text-center">Welcome to Sonam, Lalita and Samrat on behalf of Infinito Solutions bangalore</h2>
